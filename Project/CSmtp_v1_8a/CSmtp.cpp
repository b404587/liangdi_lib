...
{
	ACE_INET_Addr port_to_connect (nPort_, szServer);
	connector.connect (peer, port_to_connect);
	return 0;
...
void CSmtp::SendData()
{
	 peer.send_n (SendBuf, strlen(SendBuf));
	return ;
